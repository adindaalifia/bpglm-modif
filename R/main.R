...
bpglm<-function(Y1Y2,X1=NULL,X2=NULL,q1=NULL,q2=NULL, mxit=150, icob=NULL, mtype=1,ppy=1,
...
#print(head(X2))
      ...
      for (ita in 1:mxit) {
            ...
            Lambdas<-link_func(X1,X2,nicob1,nicob2,mtype,q1,q2)

            ## Phis
            if(is.null(phi)==TRUE){
                  Phis<-phis_func(y1,y2,X1,X2,nicob1,nicob2,tobs,nvar1,nvar2,nvar,mtype,q1,q2)
                  phi1<-Phis[1]
                  phi2<-Phis[2]
            } else{
                  phi1<-1
